...
class MainTests(unittest.TestCase):
    ...
    def test_book_detail_logged_out(self):
        ...
        # the date assertion is not working
    ...
    def test_create_author(self):
        ...
        post_data = {
            'name' : "Toni" ,
            'biography' : "Toni'\s Biography"
        }
        self.app.post('/create_author', data=post_data)
        # TODO: Verify that the author was updated in the database
        created_author = Author.query.filter_by(name='Toni').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, 'Toni')
        self.assertEqual(created_author.biography, "Toni'\s Biography")
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name='Biography').one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, 'Biography')
    ...
    def test_favorite_book(self):
        ...
        # created array of [0] to get the book
        self.assertEqual(user.favorite_books[0], book)
